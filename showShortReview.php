...
<head>
  ...
  <body>
  	...
  	<div class="container">
  			...
  			<div class="col-sm-10 col-md-offset-1">
  				<table class="table table-striped">
  					...
  					<tbody>
  						...
  						<?php
  						$query = "Select * from showusershortreview WHERE ReviewId=$revID";
          ...
          //echo "<tr></tr>";
  							echo "<tr><td>Writer</td><td>$row[4]</td></tr>";
                echo "<tr><td>Time</td><td>$row[6]</td></tr>";
                echo "<tr><td></td><td>Likes $row[8]&nbsp&nbsp&nbsp&nbspDislikes $row[9]</td></tr>";
  							echo "<tr><td>Content</td><td><p align=justify >$row[14]</p></td></tr>";
  						}
